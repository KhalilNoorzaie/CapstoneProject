...
Feature: Retail Account Page
  ...
      And User update Name 'khalilll' and Phone '6097355555'
  ...
        | 9876493213213491 | Phantom    |              11 |           2027 |          123 |
  ...
      Then a message should be displayed 'Address Updated Successfully'#Two address add update in the same time and failed please review
